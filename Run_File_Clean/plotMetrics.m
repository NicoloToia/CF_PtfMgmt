function plotMetrics(performancesMetrics)
    ...
    % This function creates a clustered bar chart to compare the performance metrics of different portfolios
        ...
        grid on;
        set(gca, 'GridLineStyle', ':', 'LineWidth', 0.7); % Linea tratteggiata per la griglia
        box on;
        ylim([0 max(data_transposed(:)) * 1.1]); % Aggiusta i limiti dell'asse Y
